...
void menu()
{
	...
	switch (valormenu)
	{
		...
		case 3:
			...
			printf("Este jogo é o resultado do projeto do terceiro estágio do grupo A da turma\n");
			printf("de Ciência da Computação - Noite, alunos do professor Renato Atouguia Leite.\n"); 
			printf("Grupo este formado pelos alunos: Daniel Nathan, Danillo Rodrigues, Luis Eduardo,\n");
 			printf("Luis Felipe e Tiago David.\n\n"); 
 			printf("O conceito deste jogo é fazer com que o jogador faça tudo usando apenas os \n");
